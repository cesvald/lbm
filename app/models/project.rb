...
class Project < ActiveRecord::Base
  ...
  state_machine :state, initial: :draft do
    ...
    after_transition [:online, :waiting_funds] => [:failed, :successful], :do => :after_transition_of_waiting_funds_to_failed_or_successful
    after_transition [:draft, :reviewed, :rejected] => :deleted, :do => :after_transition_of_draft_or_rejected_to_deleted
    after_transition :draft => :reviewed, do: :after_transition_of_draft_to_reviewed
  end
