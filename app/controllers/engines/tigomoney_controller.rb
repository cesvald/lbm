class Engines::TigomoneyController < Engines::BaseController
    ...
    def review
        ...
        if backer
            ...
            payment_params = {MasterMerchant: {account: "0985234111", pin: "1234", id: "FundacionCapital"}, Subscriber: {account:"0981989591", countryCode: "595", country: "PRY", emailId: "jose.gomez@fundacioncapital.org"}, redirectUri: respond_engines_tigomoney_index_url , callbackUri: confirm_engines_tigomoney_index_url, language: "spa", OriginPayment:{amount: backer.value, currencyCode: "PYG", tax: "0.00", fee: "0..00"}, exchangeRate: "1", LocalPayment:{amount: backer.value, currencyCode: "PYG"}, merchantTransactionId: backer.id }
    ...
    def confirm
        ...
        if params["operation"]["response_code"] == "purchasepin-2016-0000-S"
            backer.confirm!
        else
            backer.deny!
        end
